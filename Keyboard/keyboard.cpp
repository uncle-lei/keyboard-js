...
//void Keyboard::setkeyboardpositon(int x, int y)
//{
//    this->setGeometry(parentpos.x()+x, parentpos.y()+y, frmWidth, frmHeight);
//}
...
//    this->ChangeStyle();
   ...
   // this->setGeometry(pos.x()+10, pos.y() + height - frmHeight, frmWidth, frmHeight);
...
//{
//    QStringList qss;
//    qss.append(QString("QWidget#Keyboard{background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 %1,stop:1 %2);}")
